...
const MetaHead = ({ title, description, image, ogType }: HeadMetaProps) => (
  <Head>
    ...
    <meta
      property="og:image"
      content={
        image || 'https://user-images.githubusercontent.com/76927397/236601039-26c5e208-ee71-44b9-a50f-8c37ee62c4ef.jpg'
      }
    />
  </Head>
);
